...
export const menu: MenuCategory = {
  ...
  food: [
    ...
    { id: 1, name: "Waffles", description: "", ingredients: ["flour", "eggs", "milk"], spicy: false, vegetarian: true, price: 4.0 },
    { id: 2, name: "Pancakes", description: "", ingredients: ["flour", "eggs", "milk"], spicy: false, vegetarian: true, price: 3.5 },
    { id: 3, name: "Breakfast Sandwich", description: "Egg, cheese, and your choice of meat on bread", ingredients: ["egg", "bread", "meat", "cheese"], spicy: false, vegetarian: false, price: 6.0 },
  ],
  sides: [
    { id: 0, name: "Hashbrowns", description: "", ingredients: ["potato"], spicy: false, vegetarian: true, price: 2.5 },
    { id: 1, name: "Toast", description: "", ingredients: ["bread"], spicy: false, vegetarian: true, price: 1.5 },
    { id: 2, name: "Tortilla", description: "", ingredients: ["flour"], spicy: false, vegetarian: true, price: 1.0 },
    { id: 3, name: "Eggs", description: "", ingredients: ["egg"], spicy: false, vegetarian: false, price: 2.5 },
    { id: 4, name: "Chorizo", description: "", ingredients: ["chorizo"], spicy: true, vegetarian: false, price: 3.0 },
    { id: 5, name: "Sausage", description: "", ingredients: ["sausage"], spicy: false, vegetarian: false, price: 3.0 },
    { id: 6, name: "Bacon", description: "", ingredients: ["bacon"], spicy: false, vegetarian: false, price: 3.0 },
    { id: 7, name: "Bologna", description: "", ingredients: ["bologna"], spicy: false, vegetarian: false, price: 2.5 },
  ],
  mealDeals: [
